...
float DW1000Time::getAsMeters() const {
	...
	int64_t calibratedTimestamp = _timestamp - CALIBRATION_OFFSET;
    if(calibratedTimestamp < 0) calibratedTimestamp += TIME_OVERFLOW;
	return (calibratedTimestamp % TIME_OVERFLOW) * DISTANCE_OF_RADIO;
}
