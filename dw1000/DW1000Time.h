...
public:
	...
	// Device-specific calibration offset - fixed error, should read 0 when UWB devices touch
	static constexpr int64_t CALIBRATION_OFFSET = 33554432;

	// Speed of radio waves [m/s] * timestamp resolution [~15.65ps] of DW1000
	static constexpr float DISTANCE_OF_RADIO     = 0.0046917639786159f * 0.975f;
	static constexpr float DISTANCE_OF_RADIO_INV = 1 / (0.0046917639786159f * 0.975f);
