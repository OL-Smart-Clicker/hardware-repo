...
const uint8_t UWB_DEVICE_ID = 11;
...
void loop() {
  ...
  // Check if SAS token needs renewal or reconnect MQTT client
  if (timeClient.getEpochTime() >= (sas_token_expiry - 300) || !mqttClient.connected()) {
